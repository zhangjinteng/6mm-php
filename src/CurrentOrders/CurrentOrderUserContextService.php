...
final class CurrentOrderUserContextService
{
    ...
    /** @return array<int, int> */
    public function matchingPlatformUserIds(
        string $keyword,
        UserDataScope $scope,
        ?int $userType = null
    ): array {
    ...
    public function hydrateRows(array $rows, UserDataScope $scope): array
    {
        ...
        foreach ($rows as $row) {
            ...
            $row['user_type'] = isset($user->user_type) ? (int) $user->user_type : null;
